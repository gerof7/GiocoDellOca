...
public class ButtonCustom extends JButton {
    ...
    public ButtonCustom(String text, ButtonStyle style) {
    	
    	//Note: per attivare effetti hover decommentare il setBorder e gli Override
    ...
    public enum ButtonStyle {
    	...
    	WHITE(new Color(255, 255, 255), new Color(0, 0, 0), new Color(0, 0, 0), new Color(0, 0, 0));
